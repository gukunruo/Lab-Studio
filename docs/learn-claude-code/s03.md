...
![Permission Overview](/learn-claude-code/assets/s03-permission-overview.svg)
...
![Permission Pipeline](/learn-claude-code/assets/s03-permission-pipeline.svg)
...
| 新函数 | — | check\_deny\_list, check\_rules, ask\_user, check\_permission |
| 循环 | 直接执行所有工具 | 执行前插入 check\_permission() |
...
- 8 个规则来源 → 1 个本地 DENY\_LIST：概念量可控
