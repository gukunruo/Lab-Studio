...
![Worktree Overview](/learn-claude-code/assets/s18-worktree-overview.svg)
...
| 新函数 | — | create\_worktree, bind\_task\_to\_worktree, remove\_worktree, keep\_worktree, validate\_worktree\_name |
| worktree 安全 | 无 | name 校验 + 有改动时拒绝删除 |
| 事件日志 | 无 | events.jsonl 生命周期审计 |
| Lead 工具 | 14 (s17) | + create\_worktree, remove\_worktree, keep\_worktree (17) |
